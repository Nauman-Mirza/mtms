							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=user/manage_user&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Edit Info</a>
									<a class="dropdown-item" href="javascript:void(0)" onclick="showAddBalanceModal(<?php echo $row['id'] ?>)"><span class="fa fa-edit text-primary"></span> Add Balance</a>
